...
<ul class="nav navbar-nav navbar-right">
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><img src="{!! Auth::user()->gravatar !!}" class="avatar_navbar" /><span class="mobile-hide">{!! Auth::user()->username !!}</span> <span class="caret"></span></a>
