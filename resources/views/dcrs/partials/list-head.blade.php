<div class="pagehead">
    <div class="container-fluid">
        <a class="btn btn-default btn-sm pull-right btn-spacer-left" href="/pdf/log/dcrs" data-target="#modal" data-toggle="modal" title="Print to PDF."><i class="fa fa-print"></i> Print Log</a>
