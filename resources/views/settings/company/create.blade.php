...
{!! Form::open(array('id'=>'add_company_form', 'url' => 'settings/create-company', 'method' => 'post', 'class' => 'form-horizontal')) !!}
  ...
  <div class="form-group">
    <div class="col-md-offset-3 col-md-9 col-lg-offset-2 col-lg-8">
      <p class="form-control-static text-muted">*Please provide accurate information to help Aecore users find and view your company's profile. Fake/test accounts will be flagged for removal.</p>
    </div>
  </div>
