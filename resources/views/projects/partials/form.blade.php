            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        {!! Form::select('status', array( 'Bid' => 'Bid', 'Pre-construction' => 'Pre-construction', 'Under Construction' => 'Under Construction' ), null, array('class'=>'form-control', 'required'=>'true'))!!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            {!! Form::text('start', null, array('id'=>'start', 'class' => 'form-control', 'placeholder'
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            ...
                            {!! Form::text('finish', null, array('id'=>'finish', 'class' => 'form-control',
                            'placeholder' => 'Date Finish', 'required'=>'true' )) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="input-group">
                            ...
                            {!! Form::text('value', null, array('id'=>'value', 'class' => 'form-control', 'placeholder'
                            => 'ex. 155,000' )) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            {!! Form::text('size', null, array('id'=>'size', 'class' => 'form-control', 'placeholder' =>
                            'ex. 24,500')) !!}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-5">
                        {!! Form::select('country', array( '' => 'Select Country' ), null, array('class' =>
                        'form-control', 'onChange' => 'print_state(\'state\', this.selectedIndex)')) !!}
