<div class="form-inline table-filters">
    ...
    <div class="btn-group btn-spacer-left">
        ...
        <ul class="dropdown-menu" role="menu">
            ...
            <li>{!! link_to('projects', 'All Active') !!}</li>
            <li>{!! link_to('projects?filter=Bid', 'Bid') !!}</li>
            <li>{!! link_to('projects?filter=Pre-construction', 'Pre-construction') !!}</li>
            <li>{!! link_to('projects?filter=Under+Construction', 'Under Construction') !!}</li>
            <li class="divider"></li>
            <li>{!! link_to('projects?filter=Archived', 'Archived') !!}</li>
        </ul>
    </div>
</div>