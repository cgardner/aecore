        ...
        {!! Form::open(array('url' => 'auth/login', 'method' => 'post', 'style'=>'margin-bottom:20px')) !!}
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon" id="addon-password"><span class="glyphicon glyphicon-envelope"></span></span>
                    {!!Form::text('email', null, array('class'=>'form-control', 'placeholder'=>'you@yourdomain.com', 'aria-describedby' => 'addon-email', 'autofocus' => 'true'))!!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!!Form::password('password',array('class' => 'form-control', 'placeholder' => 'Password', 'aria-describedby' => 'addon-password'))!!}
                </div>
            </div>

            {!! Form::submit('Log In', array('class' => 'btn btn-success')) !!}
            {!! link_to('password', 'Forgot Password?', array('class'=>'text-muted btn-spacer-left')) !!}
        {!! Form::close() !!}
        <span>First time here? {!! link_to('signup', 'Create an Account', array('class'=>'bold')) !!}</span>
    </div>
@endsection